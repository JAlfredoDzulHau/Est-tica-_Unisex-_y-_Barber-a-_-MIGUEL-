...
<html lang="en">
  <head>
    <title>Estética Unisex y Barbería "MIGUEL"🧔✂️</title>
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/Fondo.png);" data-stellar-background-ratio="0.5">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '50%' }">
		          	<div class="text mt-5">
		          		<span class="subheading"><img src="images/logo.png" alt=""></span>
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading"><img src="images/logo.png" alt="">Belleza Natural</span>
			            <h1 class="mb-4">Salon de Belleza MIGUEL barber</h1>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/Fondo2.png);">
						</div>
					</div>
    		</div>
    	</div>
